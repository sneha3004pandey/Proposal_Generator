export const DEFAULT_CORPORATE_PROFILE = `Founded in 1992, Orient Technologies Pvt Ltd is an IT services company with 1000+ qualified professionals and rated among the top 10 solutions vendors with annual revenue of INR 600+ Crores. The company has a comprehensive network of offices and support centers in India, UAE & Singapore.
...
export const DEFAULT_ORIENT_STRENGTHS = `Orient has the capability and proven experience of managing large IT setups. The key strengths are described below:
...
export const PRE_REQUISITES_TEXT = `• User Credential with valid accesses & licenses for the developer
...
export const COMMERCIAL_NOTES_TEXT = `• Prices mentioned are exclusive of all government taxes.
